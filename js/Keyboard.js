...
const main = create('main', '',
  [create('h1', 'title', 'Virtual Keyboard for RS School Task'),
    create('h3', 'subtitle', 'Windows keyboard'),
    create('p', 'hint', 'Use left <kbd>Alt</kbd> + <kbd>Shift</kbd> to switch language. Last language saves in localStorage')]);
...
export default class Keyboard {
  ...
  switchLanguage = () => {
    ...
    this.keyButtons.forEach((button) => {
      ...
      if (keyObj.shift && keyObj.shift.match(/[^a-zA-ZąĄčČęĘėĖįĮšŠųŲūŪžŽ0-9]/g)) {
